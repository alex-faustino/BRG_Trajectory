...
public class SaveAdfTask extends AsyncTask<Void, Integer, String> {
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            // Save the ADF to the app space, so that it can be accessed by file manager

            mTango.exportAreaDescriptionFile(adfUuid, mAppSpaceAdfFolder);
    ...
    /**
     * Creates file path for ADF in app space
     */
